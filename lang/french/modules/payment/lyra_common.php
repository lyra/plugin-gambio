...
## CATALOG MESSAGES ##
define('MODULE_PAYMENT_LYRA_TECHNICAL_ERROR', "Une erreur est survenue dans le processus de paiement.");
define('MODULE_PAYMENT_LYRA_PAYMENT_ERROR', "Votre commande n'a pas pu être confirmée. Le paiement n'a pas été accepté.");
define('MODULE_PAYMENT_LYRA_CHECK_URL_WARN', "La validation automatique n'a pas fonctionné. Avez-vous configuré correctement l'URL serveur dans le back-office Lyra Collect?");
define('MODULE_PAYMENT_LYRA_CHECK_URL_WARN_DETAIL', "Afin de comprendre la problématique, reportez vous à la documentation du module :<br />&nbsp;&nbsp;&nbsp;- Chapitre «A lire attentivement avant d'aller loin»<br />&nbsp;&nbsp;&nbsp;- Chapitre «Paramétrage de l'URL serveur».");
define('MODULE_PAYMENT_LYRA_GOING_INTO_PROD_INFO', "<b>PASSAGE EN PRODUCTION :</b> Vous souhaitez savoir comment passer votre boutique en production, merci de consulter cette URL : ");
...
define('MODULE_PAYMENT_LYRA_CHECK_URL', "URL serveur à copier dans le back-office Lyra Collect: <br />");

## ADMINISTRATION INTERFACE - MISC CONSTANTS ##
define('MODULE_PAYMENT_LYRA_VALUE_0', "Désactivé");
define('MODULE_PAYMENT_LYRA_VALUE_1', "Activé");

define('MODULE_PAYMENT_LYRA_VALIDATION_DEFAULT', "Configuration back-office");
