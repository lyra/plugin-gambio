...
define('MODULE_PAYMENT_LYRA_MULTI_TEXT_TITLE', "Lyra Collect - paiement par carte bancaire en plusieurs fois");
...
define('MODULE_PAYMENT_LYRA_MULTI_STATUS_DESC', "Activer / désactiver le module de paiement Lyra Collect.");
...
define('MODULE_PAYMENT_LYRA_MULTI_SITE_ID_TITLE', "Identifiant du site");
define('MODULE_PAYMENT_LYRA_MULTI_SITE_ID_DESC', "Identifiant fourni par votre banque.");
define('MODULE_PAYMENT_LYRA_MULTI_KEY_TEST_TITLE', "Certificat en mode test");
define('MODULE_PAYMENT_LYRA_MULTI_KEY_TEST_DESC', "Certificat fourni par Lyra Collect pour le mode test (disponible sur le back-office de votre boutique).");
define('MODULE_PAYMENT_LYRA_MULTI_KEY_PROD_TITLE', "Certificat en mode production");
define('MODULE_PAYMENT_LYRA_MULTI_KEY_PROD_DESC', "Certificat fourni par Lyra Collect (disponible sur le back-office de votre boutique après passage en production).");
...
define('MODULE_PAYMENT_LYRA_MULTI_PLATFORM_URL_TITLE', "URL de la plateforme");
define('MODULE_PAYMENT_LYRA_MULTI_PLATFORM_URL_DESC', "URL vers laquelle le client sera redirigé pour le paiement.");
...
define('MODULE_PAYMENT_LYRA_MULTI_AVAILABLE_LANGUAGES_DESC', "Langues disponibles sur la page de paiement. Ne rien sélectionner pour utiliser la configuration de la plateforme.");
define('MODULE_PAYMENT_LYRA_MULTI_CAPTURE_DELAY_TITLE', "Délai avant remise en banque");
define('MODULE_PAYMENT_LYRA_MULTI_CAPTURE_DELAY_DESC', "Le nombre de jours avant la remise en banque (paramétrable sur votre back-office Lyra Collect).");
define('MODULE_PAYMENT_LYRA_MULTI_VALIDATION_MODE_TITLE', "Mode de validation");
define('MODULE_PAYMENT_LYRA_MULTI_VALIDATION_MODE_DESC', "En mode manuel, vous devrez confirmer les paiements dans le back-office de votre boutique.");
...
define('MODULE_PAYMENT_LYRA_MULTI_3DS_MIN_AMOUNT_TITLE', "Montant minimum pour lequel activer 3DS");
define('MODULE_PAYMENT_LYRA_MULTI_3DS_MIN_AMOUNT_DESC', "Nécessite la souscription à l'option 3-D Secure sélectif.");
...
define('MODULE_PAYMENT_LYRA_MULTI_REDIRECT_ENABLED_DESC', "Si activée, le client sera redirigé automatiquement vers votre site à la fin du processus de paiement.");
define('MODULE_PAYMENT_LYRA_MULTI_REDIRECT_SUCCESS_TIMEOUT_TITLE', "Temps avant redirection (succès)");
define('MODULE_PAYMENT_LYRA_MULTI_REDIRECT_SUCCESS_TIMEOUT_DESC', "Temps en secondes (0-300) avant que le client ne soit redirigé automatiquement vers votre site lorsque le paiement a réussi.");
define('MODULE_PAYMENT_LYRA_MULTI_REDIRECT_SUCCESS_MESSAGE_TITLE', "Message avant redirection (succès)");
define('MODULE_PAYMENT_LYRA_MULTI_REDIRECT_SUCCESS_MESSAGE_DESC', "Message affiché sur la plateforme de paiement avant redirection lorsque le paiement a réussi.");
define('MODULE_PAYMENT_LYRA_MULTI_REDIRECT_ERROR_TIMEOUT_TITLE', "Temps avant redirection (échec)");
define('MODULE_PAYMENT_LYRA_MULTI_REDIRECT_ERROR_TIMEOUT_DESC', "Temps en secondes (0-300) avant que le client ne soit redirigé automatiquement vers votre site lorsque le paiement a échoué.");
define('MODULE_PAYMENT_LYRA_MULTI_REDIRECT_ERROR_MESSAGE_TITLE', "Message avant redirection (échec)");
define('MODULE_PAYMENT_LYRA_MULTI_REDIRECT_ERROR_MESSAGE_DESC', "Message affiché sur la plateforme de paiement avant redirection, lorsque le paiement a échoué.");
define('MODULE_PAYMENT_LYRA_MULTI_RETURN_MODE_TITLE', "Mode de retour");
define('MODULE_PAYMENT_LYRA_MULTI_RETURN_MODE_DESC', "Façon dont le client transmettra le résultat du paiement lors de son retour à la boutique.");
define('MODULE_PAYMENT_LYRA_MULTI_ORDER_STATUS_TITLE', "Statut des commandes");
define('MODULE_PAYMENT_LYRA_MULTI_ORDER_STATUS_DESC', "Definir le statut des commandes payées par ce mode de paiement.");

## ADMINISTRATION INTERFACE - MULTI PAYMENT SETTINGS ##
define('MODULE_PAYMENT_LYRA_OPTIONS_TITLE', "Options de paiement");
define('MODULE_PAYMENT_LYRA_OPTIONS_DESC', "Cliquer sur le bouton \"Ajouter\" pour configurer une ou plusieurs options de paiement. Pour plus d'informations, merci de consulter la documentation. <b>N'oubliez pas de cliquer sur le bouton \"Sauvegarder\" afin de sauvegarder vos modifications.</b>");
